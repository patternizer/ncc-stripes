...
#------------------------------------------------------------------------------
# PROGRAM: plot_ncc_stripes_panel-2a.py
#------------------------------------------------------------------------------
# Version 0.1
# 2 December, 2021
# Michael Taylor
...
titlestr = 'Global mean anomaly, 3 Myr BCE - 500 CE'
...
# PANEL 2a.3: 11700 (Holocene) to 0 CE -------------------------------------------
...
x = np.array( list(p2x) + list(p3x) + list(p4x) + list(p5x) )
y = np.array( list(p2y) + list(p3y) + list(p4y) + list(p5y) )
...
if plot_climate_timeseries == True:
    ...
    figstr = 'climate-timeseries' + '-' + baselinestr + '-' + 'Panel-2a' + '.png'
...
if plot_climate_bars == True:
    ...
    figstr = 'climate-bars' + '-' + baselinestr + '-' + 'Panel-2a' + '.png'
...
if plot_climate_stripes == True:
    ...
    figstr = 'climate-stripes' + '-' + baselinestr + '-' + 'Panel-2a' + '.png'
...
if plot_climate_stripes == True:
    ...
    figstr = 'climate-line' + '-' + baselinestr + '-' + 'Panel 2a' + '.png'
