...
#------------------------------------------------------------------------------
# PROGRAM: plot_ncc_stripes_panel-3b.py
#------------------------------------------------------------------------------
# Version 0.1
# 2 December, 2021
# Michael Taylor
...
titlestr = 'Global mean anomaly, 1850 CE - 2020 CE'
...
if plot_climate_timeseries == True:
    ...
    figstr = 'climate-timeseries' + '-' + baselinestr + '-' + 'Panel-3b' + '.png'
...
if plot_climate_bars == True:
    ...
    figstr = 'climate-bars' + '-' + baselinestr + '-' + 'Panel-3b' + '.png'
...
if plot_climate_stripes == True:
    ...
    figstr = 'climate-stripes' + '-' + baselinestr + '-' + 'Panel-3b' + '.png'
...
if plot_climate_stripes == True:
    ...
    figstr = 'climate-line' + '-' + baselinestr + '-' + 'Panel 3b' + '.png'
