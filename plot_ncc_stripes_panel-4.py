...
#------------------------------------------------------------------------------
# PROGRAM: plot_ncc_stripes_panel-4.py
#------------------------------------------------------------------------------
# Version 0.1
# 2 December, 2021
# Michael Taylor
...
titlestr = 'Global mean anomaly, 2020 CE - 2200 CE: ' + projectionstr
...
if plot_climate_timeseries == True:
    ...
    figstr = 'climate-timeseries' + '-' + baselinestr + '-' + 'Panel-4' + '-' + projectionstr + '.png'
...
if plot_climate_bars == True:
    ...
    figstr = 'climate-bars' + '-' + baselinestr + '-' + 'Panel-4' + '-' + projectionstr + '.png'
...
if plot_climate_stripes == True:
    ...
    figstr = 'climate-stripes' + '-' + baselinestr + '-' + 'Panel-4' + '-' + projectionstr + '.png'
