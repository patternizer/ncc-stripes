...
titlestr = 'Global mean anomaly, 65.5 Myr BCE - 2020 CE'
...
y4 = df[ (df.Year >= -10000) & (df.Year < 0) ]['Global']
x4 = df[ (df.Year >= -10000) & (df.Year < 0)]['Year']
...
# PANEL 6: 1850 (HadCRUT5) to 2020 CE (no FaIR) -------------------------------
...
p6x = np.linspace( p6start + p6unit/2., p6end - p6unit/2., p6n ) # [+1855, 2015]
p6y = s6.statistic
...
if plot_climate_timeseries == True:
    ...
    figstr = 'climate-timeseries' + '-' + baselinestr + '-' + 'past' + '.png'
...
if plot_climate_bars == True:
    ...
    figstr = 'climate-bars' + '-' + baselinestr + '-' + 'past' + '.png'
...
if plot_climate_stripes == True:
    ...
    figstr = 'climate-stripes' + '-' + baselinestr + '-' + 'past' + '.png'
...
if plot_climate_stripes == True:
    ...
    figstr = 'climate-line' + '-' + baselinestr + '-' + 'past' + '.png'
