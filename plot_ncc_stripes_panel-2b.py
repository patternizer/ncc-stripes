...
#------------------------------------------------------------------------------
# PROGRAM: plot_ncc_stripes_panel-2b.py
#------------------------------------------------------------------------------
# Version 0.1
# 2 December, 2021
# Michael Taylor
...
titlestr = 'Global mean anomaly, 500 CE - 1400 CE'
...
if plot_climate_timeseries == True:
    ...
    figstr = 'climate-timeseries' + '-' + baselinestr + '-' + 'Panel-2b' + '.png'
...
if plot_climate_bars == True:
    ...
    figstr = 'climate-bars' + '-' + baselinestr + '-' + 'Panel-2b' + '.png'
...
if plot_climate_stripes == True:
    ...
    figstr = 'climate-stripes' + '-' + baselinestr + '-' + 'Panel-2b' + '.png'
...
if plot_climate_line == True:
    ...
    figstr = 'climate-line' + '-' + baselinestr + '-' + 'Panel-2b' + '.png'
